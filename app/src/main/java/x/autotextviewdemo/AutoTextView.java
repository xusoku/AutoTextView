...
/**
 * Created by xushengfu on 16/7/11.
 */
public class AutoTextView extends TextSwitcher implements
    ...
    private int count = 0;
    private setClickListener onClickListener;
    ...
    public AutoTextView(Context context, AttributeSet attrs) {
        ...
        textSize = a.getDimension(R.styleable.auto3d_textSize, 36);
        a.recycle();
        mContext = context;
        init();
    }
    ...
    public void setOnClickListener(setClickListener onClickListener) {
        ...
        t.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (onClickListener != null) {
                    onClickListener.onClick((count - 1) % listData.size());
                }
            }
        });
        return t;
    ...
    private void setTextData() {
        if (listData != null) {
            setText(count + "" + ((Model) listData.get((count) % listData.size())).title);
            count++;
        }
    }
